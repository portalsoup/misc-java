...
import com.jcleary.annotations.processors.HackProcessor;
import com.jcleary.annotations.processors.SourceFile;
...
public class Compiler {
    ...
    static {
        ...
        classPathEntries.add(classPathFor(HackProcessor.class));
        classPathEntries.add(classPathFor(Hack.class));
    }
